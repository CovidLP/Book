...
#### Listing 15.13, 15.14 and 15.15: it generates Figure 15.11 ####
...
#Run this to load the datas
#data <- readRDS("data/Data - SumRegions.rds")

#Run this to load pre-executed fit
# outputs <- readRDS("results/Results - SumRegions.rds")
