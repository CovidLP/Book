...
### Next contents
#
# (1) Generate Figure 6.7 from the "rds" files available in the Github path "Part2/Chapter6/data/"
# (2) Download US data from John Hopkins repository
# (3) Run generalised logistic model with 2 curves using Stan and generate the "lt_predict" object used in Figure 6.7
#
# The codes in (2) and (3) generate "rds" files with objects to generate Figure 6.7. These "rds" files
# are reduced when compared to the ones in "Part2/Chapter6/data/", but have enough information to
# generate Figure 6.7 with the codes in (1). 



### (1) Generate Figure 6.7
