...
### Observed data (available in https://github.com/CovidLP/Book/tree/main/Part2/Chapter6/data)
Y<- readRDS(file = paste0(data_directory, "data_Brazil.rds"))

### MCMC results (available in https://github.com/CovidLP/Book/tree/main/Part2/Chapter6/results)
